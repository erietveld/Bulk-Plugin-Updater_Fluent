...
Record({
    $id: Now.ID['flow_process_plugin_updates_v2'],
    table: 'sys_hub_flow',
    data: {
        ...
        type: 'subflow',
        version: '2',
        version_record: 'bfed5700fb91be105543f4c69eefdc4d'
    }
})
